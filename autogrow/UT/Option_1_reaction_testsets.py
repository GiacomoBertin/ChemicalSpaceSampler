...
#B_arylethylamine
B_arylethylamine_1 = Chem.MolFromSmiles("c1cc(CCN)ccc1")
B_arylethylamine_2 = Chem.MolFromSmiles("c1cc(CCN)ccc1(C)")
B_arylethylamine_3 = Chem.MolFromSmiles("c1cc(CCN)cc(C)c1(C)")
B_arylethylamine_4 = Chem.MolFromSmiles("c1c(C)c(CCN)cc(C)c1(C)")
B_arylethylamine_5 = Chem.MolFromSmiles("c1(C)c(C)c(CCN)cc(C)c1(C)")
B_arylethylamine_6 = Chem.MolFromSmiles("c1(C)c(C)c(CCN)cc(C)c1(C)")
B_arylethylamine_7 = Chem.MolFromSmiles("c1(C)c(C)c(CCN)c(C)c(C)c1(C)") # Should Fail
B_arylethylamine_8 = Chem.MolFromSmiles("c1c(C)c(CCN)c(C)cc1(C)")# Should Fail
B_arylethylamine_9 = Chem.MolFromSmiles("c1c(C)c(CCN)c(C)cc1")# Should Fail

B_arylethylamine_mols = [B_arylethylamine_1,B_arylethylamine_2,B_arylethylamine_3,B_arylethylamine_4,B_arylethylamine_5,B_arylethylamine_6,B_arylethylamine_7,B_arylethylamine_8,B_arylethylamine_9]

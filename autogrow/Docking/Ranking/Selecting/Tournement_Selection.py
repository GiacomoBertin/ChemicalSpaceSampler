...
def Run_Tournement_Selector(list_of_ligands, num_to_chose, tourn_size, idx_to_sel, favor_most_negative=True):
    ...
    This is done WITH REPLACEMENT, so there may be redudancy in the chosen_ligands list. This does provide 
    an opportunity for any ligand to make it into the chosen_ligands list even if it doesn't have a high score,

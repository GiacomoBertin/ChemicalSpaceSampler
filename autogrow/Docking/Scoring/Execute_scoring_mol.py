...
from autogrow.Docking.Scoring.Scoring_classes.Scoring_functions import *
from autogrow.Docking.Docking_Class.get_child_dock_class import get_all_subclasses
from autogrow.Docking.Scoring.Scoring_classes.ParentScoringClass import ParentScoring

from autogrow.Docking.Scoring.Scoring_classes.Scoring_functions import VINA 
from autogrow.Docking.Scoring.Scoring_classes.Scoring_functions import Lig_Efficiency
from autogrow.Docking.Scoring.Scoring_classes.Scoring_functions import NN1
from autogrow.Docking.Scoring.Scoring_classes.Scoring_functions import NN2
...
def run_scoring_common(vars, smile_file, folder_to_search):
    ...
    scoring_choice = vars['scoring_function']
    ...
    scoringObject = scoring_class(temp_vars, smiles_dict)
    ...
    job_input_files_to_score = tuple([tuple([scoringObject, file_path, rescore_Lig_Efficiency]) for file_path in files_to_score])
...
def score_files_multithread(scoringObject, file_path, rescore_Lig_Efficiency):
    """
    ...
    if rescore_Lig_Efficiency == True:
        list_of_lig_data = Lig_Efficiency.append_lig_effeciency(list_of_lig_data)

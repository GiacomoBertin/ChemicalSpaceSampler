    ...
    def get_score_from_a_file(self,file_path):
        ...
        with open(file_path, 'r') as f:
            while True:
                ...
                if "When the poses were ranked by the best of the 20 network scores" in line:
                    line = f.readline()
                    ...
                    score = score * -1.0
                    break
                elif "Best Score:" in line or "Best score:":
...
def run_NN_rescoring(vars, vina_output_file):
    ...
    torun = sys.executable + " "+ nn2_executable + " -receptor " + receptor + \
            " -ligand " + lig + " -docking_executable " + docking_executable + \
            " > " + str(nn2_output)

...
from autogrow.Docking.Docking_Class.DockingClassChildren import VinaDocking
from autogrow.Docking.Docking_Class.DockingClassChildren import QuickVina2Docking


def pick_run_class_dict(Dock_choice):
    """
...
def run_docking_common(vars, current_gen_int, current_generation_dir, smile_file_new_gen):
    ...
    dock_class = pick_run_class_dict(Dock_choice)
    dockingObject = dock_class(temp_vars, receptor)
